...
export const projects = [
  ...
  },
  {
    ...
    subtitle: 'Desktop control with bare hands',
    description:
      'MediaPipe Tasks hand tracking drives a pure, unit-tested gesture engine: system volume by hand height, media transport with pinches and swipes, presentation control. Pinch hysteresis + a swipe FSM make physical wobble a non-issue.',
    tech: ['MediaPipe Tasks', 'OpenCV', 'pycaw', 'pynput', 'pytest'],
    links: { code: 'https://github.com/flogduse/gesture-control', demo: null },
    tag: 'FLAGSHIP',
    accent: 'blue',
  ...
  },
  {
    ...
    description:
      'The origin project: real-time spatial tracking with OpenCV and MediaPipe — physics-based UI elements manipulated purely through hand gestures. Now evolved into Gesture-Control above.',
  ...
  },
  {
    ...
    description:
      'Console games, a file-handling to-do app and a CLI calculator — the honest foundation layer every engineer has. Plus backend experiments routing AI model endpoints.',
    tech: ['Python', 'JavaScript', 'Node'],
    links: { code: 'https://github.com/flogduse', demo: null },
    tag: 'FOUNDATIONS',
    accent: 'yellow',
...
export const building = [
  {
    ...
    description: 'SHIPPED v1 — chat with your syllabus: FastAPI + LangChain-style RAG over course PDFs, streaming cited answers. Live locally; case study + hosted demo next.',
